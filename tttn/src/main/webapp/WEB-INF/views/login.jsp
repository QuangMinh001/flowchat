...
<%-- 			<a href="${classpath }/login_processing" role="button"
			...
			<a role="button" href="${classpath }/signup" class="form-submit" style="position: absolute; margin-top:75px; left:30px; bottom:5px; text-decoration: none; max-width:160px">Sign up</a>
			<a role="button" href="${classpath }/signup" class="form-submit" style="position: absolute; margin-top:75px; right:30px; bottom:5px; text-decoration: none; max-width: 160px">Forgot password</a>
		</form>
	</div>
